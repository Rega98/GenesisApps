        ...
        <form action="ClienteController">
            <div class="row my-3">
                <div class="col-3">
                    ...
                    <input type="text" class="form-control" name="txtRfcCli" required>
                </div>
                <div class="col-6">
                    <label for="txtNomCli" class="form-label">Nombre</label>
                    <input type="text" class="form-control" name="txtNomCli" required>
                </div>
                <div class="col-6">
                    <label for="txtAppPCli" class="form-label">Apellido Paterno</label>
                    <input type="text" class="form-control" name="txtAppPCli" required>
                </div>
                <div class="col-6">
                    <label for="txtAppMCli" class="form-label">Apellido Materno</label>
                    <input type="text" class="form-control" name="txtAppMCli" required>
                </div>
            </div>
            <div class="row my-3">
                <div class="col-6">
                    <label for="txtDirCli" class="form-label">Dirección</label>
                    <input type="text" class="form-control" name="txtDirCli" required>
                </div>
                <div class="col-3">
                    <label for="txtTelCli" class="form-label">Telefono</label>
                    <input type="text" class="form-control" name="txtTelCli" required>
                </div>
                <div class="col-6">
                    <label for="txtCorreoCli" class="form-label">Correo</label>
                    <input type="email" class="form-control" name="txtCorreoCli" required>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-8"></div>
