        ...
        <div class="container">
            <div class="row">
                <div>
                    ...
                    <br>
                    <a href="EmpleadoController?action=add" class="btn btn-success" id="btnAdd" role="button">Agregar Empleado</a>
                </div>
            </div>
        </div>
        <br>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="EmpleadoController?action=edit" class="btn btn-primary" id="btnEdit" role="button">Editar</a>
