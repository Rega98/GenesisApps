        ...
        <form action="GastoController">
            ...
            <div class="row my-3">
                <div class="col-3">
                    ...
                    <input type="number" class="form-control" name="txtCivaGasto" min="0" step="0.1" required>
                </div>
                <div class="col-3">
                    ...
                    <input type="number" class="form-control" name="txtSivaGasto" min="0" step="0.1" required>
                </div>
                <div class="col-3">
