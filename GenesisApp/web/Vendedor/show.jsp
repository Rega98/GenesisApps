<%-- 
    Document   : show
    Created on : 24 nov 2021, 23:14:40
    Author     : uriel
--%>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" >
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Geminis App | Vendedor</a>
                ...
                <div class="col-sm-4">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <a href="VendedorController?action=show" class="btn btn-primary">Menú Vendedor</a>
                    </div>
                  </div>
                </div>
                <div class="col-sm-4">
