            ...
            <form action="CompraController">
               <div class="row my-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" id="NumCantidadCom" name="txtCantCom" required>
                </div>
                <div class="col-md-4">
              ...
              <div class="row my-3">
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" id="numberMonto" name="txtMontotCom" required>
                </div>
                <div class="col-md-4">
